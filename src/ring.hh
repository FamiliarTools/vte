...
private:
         ...
         * which is what the first version did: the last two bytes were then
         * the tail of the image reference, the backwards walk decoded a
         * garbage length, and every frozen row silently lost its attributes.
         *
