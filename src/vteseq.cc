...
Terminal::XTERM_SMGRAPHICS(vte::parser::Sequence const& seq)
{
        ...
        case 2: /* SIXEL graphics geometry.
                 ...
                 * the cell insert_image lays images out against, so that a sender
                 * sizing an image from this reply gets an image that occupies the
                 * cells it expected. The maximum is the parser's cap, which does not
                ...
                case 1: { /* read current */
                         ...
                         * that this reply, CSI 14t and TIOCGWINSZ agree, now
                         * and after any font change.
                         */
